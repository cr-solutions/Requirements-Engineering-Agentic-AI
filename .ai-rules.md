...
## 8. Context History
* **File:** create and update each time the context histoy per task as example under .kiro/ or .steering/ in the following format CONTEXT\_HISTORY\_\<year\>-\<month\>-\<day\>\_\<task_name\>.md or in a other meaningful location preferred by your LLM
