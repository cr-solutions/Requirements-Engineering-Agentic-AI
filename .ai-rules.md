...
## 8. Context History
* **File:** create and update each time the context histoy per task as example under .kiro/ in the following format CONTEXT\_HISTORY\_\<year\>-\<month\>-\<day\>\_\<task_name\>.md
