...
## 8. Context History
* **File** create and update each time the context histoy per task a example under .kiro/ in the following format CONTEXT_HISTORY_<year>-<month>-<day>_<task_name>.md
